...
list_epoch = [19,45,73,102,134,169]
...
name = 'ag_lr' + str(args.lr) + '_u' + str(user_per_epoch) + '_clip' + str(S) + '_ns' + str(noise_scale) + '_emb' + str(args.emsize) + '_len' + str(seq_len) + '_' + str(load_wt103) + 'Wt103_30k_User_gauss_seed' + str(args.seed) 
dir_path = '../results/runs_lm_User_AG_gauss/'
...
try:
    ...
    c = 0
    for epoch in range(resume_epoch, nepochs + 1):# range(1, args.2epochs+1):
        model.train()
        ...
        for i in user_active:
            ...
            c += 1
            print(i)
            user_data, user_targets, user_len = get_data_user(train_data, train_len, i, num_user_train, args, seq_len)
