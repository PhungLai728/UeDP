...
name = 'ag_lr' + str(args.lr) + '_u' + str(user_per_epoch) + '_clip' + str(S) + '_ns' + str(noise_scale) + '_emb' + str(args.emsize) + '_len' + str(seq_len) + '_' + str(load_wt103) + 'Wt103_30k_noDP_glove_gauss_seed' + str(args.seed) 
# name = name_resume + '_resume' 
dir_path = '../results_classification/AG_nonDP/'
