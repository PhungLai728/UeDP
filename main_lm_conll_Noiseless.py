...
name = 'conll_lr' + str(args.lr) + '_user' + str(user_per_epoch) + '_clip' + str(S) + '_emb' + str(args.emsize) + '_len' + str(seq_len) + '_' + str(load_wt103) + 'Wt103_NoDP_seed' + str(args.seed) 
dir_path = '../results/runs_lm_conll_NoDP/'
