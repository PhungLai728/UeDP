...
# parser.add_argument('--data', type=str, default='code_ue/data/AG_dataset/',
...
name = 'ag_lr' + str(args.lr) + '_u' + str(user_per_epoch) + '_clip' + str(S) + '_ns' + str(noise_scale) + '_emb' + str(args.emsize) + '_len' + str(seq_len) + '_' + str(load_wt103) + 'Wt103_30k_DeInd_seed' + str(args.seed) 
dir_path = '../results/runs_lm_AG_DeInd/'
