...
import model_classification_glove
...
list_epoch = [19, 45, 73, 102, 134, 169,728]#,717,1030]
nepochs = list_epoch[-1] #args.epochs #37217 # 335
...
name = 'ag_lr' + str(args.lr) + '_u' + str(user_per_epoch) + '_clip' + str(S) + '_ns' + str(noise_scale) + '_emb' + str(args.emsize) + '_len' + str(seq_len) + '_' + str(load_wt103) + 'Wt103_30k_UserDP_glove_gauss_seed' + str(args.seed) 
# name = name_resume + '_resume' 
dir_path = '../results_classification/ag_UserDP/'
...
model = model_classification_glove.RNNModel(args.model, ntokens, word_embeds, args.emsize, args.nhid, args.nlayers, args.dropout, args.dropouth, args.dropouti, args.dropoute, args.wdrop, args.tied)
model_local = model_classification_glove.RNNModel(args.model, ntokens, word_embeds, args.emsize, args.nhid, args.nlayers, args.dropout, args.dropouth, args.dropouti, args.dropoute, args.wdrop, args.tied)
