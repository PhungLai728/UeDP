...
parser.add_argument('--loadpre', type=int, default=1,
...
seq_len = 10
list_epoch = [19,171,407,735,1150,1649]
...
name = 'conll_lr' + str(args.lr) + '_user' + str(user_per_epoch) + '_clip' + str(S) + '_ns' + str(noise_scale) + '_emb' + str(args.emsize) + '_len' + str(seq_len) + '_' + str(load_wt103) + 'Wt103_UserDP_seed' + str(args.seed) 
dir_path = '../results/runs_lm_conll_UserDP/'
